...
<template>
    <AppLayout>
        ...
        <!-- HERO SECTION -->
        <section class="relative min-h-[90vh] bg-cover bg-right lg:bg-center overflow-hidden flex items-center"
            style="background-image: url(&quot;/images/bg/hero.png&quot;)">
            <div class="relative z-20 max-w-7xl mx-auto w-full px-4 lg:px-8">
                <div class="flex justify-center lg:justify-start" data-aos="fade-up" data-aos-duration="1000">
                    <div class="text-center lg:text-left">
                        <img src="/public/images/logo/kabinet.png" class="w-56 lg:w-80 mx-auto lg:mx-0 drop-shadow-2xl"
                            alt="Logo Kabinet" />

                        <div class="mt-6 text-center lg:text-left">
                            <p class="text-white lg:text-gray-600 font-bold text-xl lg:text-3xl tracking-widest">
                                KABINET
                            ...
                            <p class="text-white/80 lg:text-gray-600 text-lg lg:text-xl mt-3 font-light">
        ...
        <section class="py-24 bg-slate-50">
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center mb-16" data-aos="fade-up">
                    <span class="text-green-600 font-semibold tracking-wider text-sm">SAPA HANGAT</span>
                    <h2 class="text-4xl lg:text-5xl font-bold text-blue-900 mt-2 mb-4">
                        Sambutan Pimpinan
                    </h2>
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
                    ...
                    <div data-aos="fade-right">
                        <div class="flex justify-center mb-8">
                            <div class="bg-white p-1.5 rounded-full shadow-md flex gap-1 border border-gray-100">
                                <button @click="activeLeader = 'presiden'" :class="[
                                ...
                                <button @click="activeLeader = 'wapres'" :class="[
                                    'px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-300',
                                    activeLeader === 'wapres'
                                        ? 'bg-blue-700 text-white shadow-lg shadow-blue-700/30'
                                        : 'text-gray-600 hover:bg-gray-100',
                        ...
                        <div
                            ...
                            <img :src="currentLeader.photo" class="w-full h-full object-cover" />

                            <div class="absolute inset-0 bg-gradient-to-t from-blue-900 via-blue-900/60 to-transparent">
                            </div>
                            ...
                            <div class="absolute bottom-0 left-0 p-8 text-white w-full">
                                ...
                                <p class="text-green-400 font-medium text-lg mt-1">
                    ...
                    <div data-aos="fade-left">
                        <div class="relative">
                            ...
                            <div class="text-gray-700 leading-relaxed text-lg mb-8 border-l-4 border-yellow-500 pl-6 space-y-4"
        ...
        <section class="py-24 text-white relative overflow-hidden">
            ...
            <!-- Blue Overlay -->
            <div class="absolute inset-0 bg-gradient-to-r from-blue-800 via-blue-700/80 to-blue-800"></div>

            <div class="relative max-w-7xl mx-auto px-4">
                <div class="text-center mb-16" data-aos="fade-up">
                    <span class="text-green-300 font-semibold tracking-wider text-sm">PROFIL ORGANISASI</span>
        ...
        <section class="py-24 bg-white">
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center mb-16">
                    <span class="text-green-600 font-semibold tracking-wider text-sm">UPDATE TERKINI</span>
                    <h2 class="text-4xl lg:text-5xl font-bold text-blue-900 mt-2 mb-4">
                        Kegiatan & Berita
                    </h2>
                    <div class="w-24 h-1.5 bg-gradient-to-r from-green-500 to-blue-600 mx-auto rounded-full"></div>
                ...
                <div class="mb-20">
                    <h3 class="text-2xl font-bold text-blue-800 mb-8 flex items-center gap-2">
                        Highlight Kegiatan
                    </h3>
                    ...
                    <div class="relative event-swiper-wrapper">
                        ...
                        <Swiper :modules="[
                            ...
                            Autoplay,
                            EffectCoverflow,
                        ]" effect="coverflow" :grab-cursor="true" :centered-slides="true" :loop="true"
                            ...
                            <SwiperSlide v-for="event in props.pastEvents" :key="event.id" class="custom-slide">
                                <!-- MOBILE VERSION -->
                                <div
                ...
                <div v-if="props.ongoingEvent"
                    ...
                    <div class="grid lg:grid-cols-3 gap-8 items-center">
                        <div class="lg:col-span-2">
                            <div class="inline-flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full mb-4">
                    ...
                    <div class="grid lg:grid-cols-3 gap-8 items-center">
                        <div class="lg:col-span-2">
                            <div class="flex items-center gap-2 mb-3">
                                ...
                                <span class="uppercase tracking-wider text-sm font-semibold">
                                    Kegiatan Mendatang
                                </span>
                            </div>
                            ...
                            <p class="flex items-center gap-2 text-blue-100 mb-1">
                                <MapPin class="w-4 h-4" />
                        ...
                        <div class="bg-white/10 backdrop-blur-md rounded-lg p-6 text-center border border-white/20">
                            ...
                            <div class="flex justify-center gap-6">
                                <div>
                                    ...
                                    <span class="text-sm text-blue-100">Hari</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span class="text-sm text-blue-100">Jam</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span class="text-sm text-blue-100">Menit</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span class="text-sm text-blue-100">Detik</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section
            ...
            <div class="relative mx-auto max-w-7xl px-4">
                ...
                <div
                    ...
                    <div
                        ...
                        <!-- ORIGINAL -->
                        <div v-for="(logo, index) in externalPartners" :key="'ext1' + index"
                        ...
                        <!-- DUPLICATE -->
                        <div v-for="(logo, index) in externalPartners" :key="'ext2' + index"
                            class="group/card relative flex h-[150px] w-[150px] flex-shrink-0 items-center justify-center transition-all duration-500 hover:scale-110">
                            <!-- Light Decoration -->
                            <div
                                class="absolute top-0 right-0 w-20 h-20 rounded-full bg-white blur-2xl opacity-20 transition-all duration-500 group-hover/card:opacity-40">
                ...
                <div
                    ...
                    <div
                        ...
                        <!-- ORIGINAL -->
                        <div v-for="(logo, index) in internalPartners" :key="'int1' + index"
                            class="group/card relative flex h-[150px] w-[150px] flex-shrink-0 items-center justify-center transition-all duration-500 hover:scale-110">
                            <!-- Light Decoration -->
                            <div
                                class="absolute top-0 right-0 w-20 h-20 rounded-full bg-white blur-2xl opacity-20 transition-all duration-500 group-hover/card:opacity-40">
                        ...
                        <!-- DUPLICATE -->
                        <div v-for="(logo, index) in internalPartners" :key="'int2' + index"
                            class="group/card relative flex h-[150px] w-[150px] flex-shrink-0 items-center justify-center transition-all duration-500 hover:scale-110">
                            <!-- Light Decoration -->
                            <div
                                class="absolute top-0 right-0 w-20 h-20 rounded-full bg-white blur-2xl opacity-20 transition-all duration-500 group-hover/card:opacity-40">
            ...
            <div class="relative mt-24 flex flex-col items-center">
                <!-- Divider -->
                <div class="mb-10 h-px w-40 bg-gradient-to-r from-transparent via-white/40 to-transparent"></div>
                ...
                <div
                    ...
                    <span class="text-xs font-medium uppercase tracking-[0.3em] text-white/70">
                        Connect With Us
                    </span>
                </div>
                ...
                <div class="flex flex-wrap items-center justify-center gap-5">
                    ...
                    <!-- Email -->
                    <a href="mailto:bem@ibrahimy.ac.id"
