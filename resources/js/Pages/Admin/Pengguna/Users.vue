    ...
    <AppLayout>
        ...
        >
            ...
            <div class="flex gap-4 justify-between items-center mb-6">
                ...
                <button
                    ...
                    class="flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-600 text-white rounded-xl shadow-sm hover:shadow-md hover:shadow-green-500/30 transition-all duration-300 transform hover:scale-103 active:scale-97"
                >
            ...
            >
                    ...
                    <table class="min-w-full text-sm text-left">
                        <thead>
                            ...
                            >
                                ...
                                <th
                                    ...
                                    :key="col.key"
                                    class="px-4 py-3 cursor-pointer select-none hover:bg-green-700/70 transition-colors"
                        ...
                        <tbody>
                            <tr
                                ...
                                :key="user.id"
                                class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all"
                            >
                                <td
                                ...
                                <td class="px-4 py-3">
                                    <div class="relative">
                                        <select
                                            ...
                                            class="w-full appearance-none rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gradient-to-r from-gray-800 to-gray-900 pl-2 pr-8 py-2 text-sm text-gray-700 dark:text-white shadow-sm transition hover:border-gray-400 focus:outline-none focus:ring-1 focus:ring-green-600 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed"
                                            :disabled="
                                                user.roles.some(
                                                    (r) =>
                                                        r.name === 'super-admin'
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    >
                                        <button
                                            ...
                                            "
                                            class="flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 hover:from-green-100 hover:to-green-50 dark:hover:from-green-900/30 dark:hover:to-green-900/30 text-gray-900 dark:text-gray-100 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition-all duration-300 transform group/btn"
                                        >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <li
                                                            ...
                                                            "
                                                            class="px-4 py-2 hover:bg-green-100 dark:hover:bg-green-900/40 cursor-pointer transition-all"
                                                        >
                                                            View
                                                        </li>
                                                        <li
                ...
                <!-- Mobile Cards -->
                <div
                    class="md:hidden space-y-4 p-4 bg-green-50 dark:bg-gray-800 rounded-b-lg"
                >
                    <div
                        v-for="(user, index) in users.data"
                        :key="user.id"
                        ...
                        <div class="flex justify-between items-start mb-3">
                            ...
                            <div class="relative inline-block text-left">
                                <button
                                    ...
                                    class="flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 hover:from-green-100 hover:to-green-50 dark:hover:from-green-900/30 dark:hover:to-green-900/30 text-gray-900 dark:text-gray-100 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm transition-all duration-300 transform group/btn"
                                >
            ...
            <div v-if="!users.data.length" class="text-center py-12">
                ...
                <button
                    @click="openModal = true"
                    class="inline-flex items-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
                >
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <select
                        ...
                        class="px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:ring-2 focus:ring-green-600 focus:outline-none bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 cursor-pointer"
                    >
        ...
        <teleport to="body">
            ...
            >
                ...
                >
                    <div
                        class="relative bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-md mx-auto"
                        @click.stop
                    >
                        <!-- Header Modal -->
                        <div
                        ...
                        <form @submit.prevent="submit" class="p-5 space-y-4">
                            <div class="space-y-3">
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        class="block w-full px-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-600 focus:border-transparent focus:outline-none transition-all duration-200 shadow-sm hover:shadow-md"
                            ...
                            <button
                                type="submit"
                                class="w-full flex items-center justify-center gap-3 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-600 text-white rounded-lg shadow-lg hover:shadow-xl hover:shadow-green-600/30 transition-all duration-300 transform hover:scale-103 active:scale-97 font-semibold"
                            >
                                <Save class="w-5 h-5" />
                        ...
                        <div class="p-6 space-y-6">
                            <div class="flex flex-col items-center text-center">
                                <div class="relative mb-4">
                                    ...
                                    />
                                    <div
                                        class="absolute -bottom-2 -right-2 w-6 h-6 bg-green-500 rounded-full border-2 border-white dark:border-gray-900"
                                    ></div>
                                </div>
                                <h3
                                    class="text-xl font-bold text-gray-900 dark:text-gray-100"
                            ...
                            <div class="flex gap-3 pt-4">
                                <button
                                    ...
                                    class="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-600 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95 font-semibold"
                                >
                                    <Edit class="w-4 h-4" />
                                    Edit User
                                </button>
