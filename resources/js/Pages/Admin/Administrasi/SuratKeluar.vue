<template>
    <AppLayout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div
                class="group relative p-8 bg-gradient-to-r from-white via-yellow-50 to-white hover:bg-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-500 overflow-hidden"
            >
                <!-- Background Effects -->
                <div
                ...
                <div class="relative z-10">
                    <div class="flex items-start justify-between mb-4">
                        ...
                        <button
                            @click="goToMasuk"
                            class="p-2 text-yellow-800 rounded-full bg-yellow-800/20 hover:bg-yellow-800/30 transition-all duration-300 backdrop-blur-sm transform hover:scale-110 active:scale-95"
                        >
            ...
            <div
                class="group relative p-8 bg-green-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-500 overflow-hidden"
            >
                <!-- Background Effects -->
                <div
                    class="absolute top-0 right-0 w-32 h-32 bg-yellow-500/5 rounded-full -translate-y-16 translate-x-16 group-hover:scale-150 transition-transform duration-700"
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <span class="hidden md:block">Tambah Surat Keluar</span>
                </button>
            </div>
        ...
        <!-- Modal Create / Edit Surat Keluar -->
        <teleport to="body">
            <!-- BACKDROP -->
            <Transition
                ...
                >
                    ...
                    >
                        ...
                        <form @submit.prevent="submit" class="p-5 space-y-4">
                            ...
                            <button
                                type="submit"
                                class="w-full flex items-center justify-center gap-3 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-600 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-103 font-semibold"
                            >
                                <Save class="w-5 h-5" />
                                <span>{{
...
function applyFilters() {
    router.get(route("surat-keluar.index"), filters.value, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
    });
...
const submit = () => {
    ...
    data.append("tujuan", form.value.tujuan);
    ...
    if (isEdit.value) {
        ...
        router.post(route("surat-keluar.update", editId.value), data, {
            forceFormData: true,
            onSuccess: closeModal,
        });
    } else {
        router.post(route("surat-keluar.store"), data, {
            forceFormData: true,
            onSuccess: closeModal,
        });
    }
