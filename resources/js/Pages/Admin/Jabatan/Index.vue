        ...
        >
            ...
            >
                ...
                <div class="relative w-full md:w-80">
                    ...
                    <input
                        ...
                        @input="applyFilters"
                        placeholder="Cari jabatan / departemen..."
                ...
                <div class="flex items-center gap-3">
                    ...
                    >
                        <span class="hidden md:block">Periode</span>
                        <ArrowUpRight
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                <div>
                    <!-- IKSASS SANTRI -->
                    <div
                        class="px-4 py-3 rounded-xl mb-4 font-bold text-white bg-gradient-to-r from-green-600 to-green-700"
                    >
                        IKSASS Santri
                    </div>
                    ...
                    >
                        <table class="min-w-full text-sm text-left">
                            ...
                            <tbody>
                                <tr
                                    v-for="(item, index) in santriData"
                                    :key="item.id"
                ...
                <div>
                    <div
                        class="px-4 py-3 rounded-xl mb-4 font-bold text-white bg-gradient-to-r from-yellow-600 to-yellow-700"
                    >
                        IKSASS Alumni
                    </div>
                    <div
                        ...
                        <form @submit.prevent="submit" class="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="IKSASS Santri">
                                        IKSASS Santri
                                    </option>
                                    <option value="IKSASS Alumni">
                                        IKSASS Alumni
                                    </option>
                                </select>
                            </div>
                            ...
                            <button
                                type="submit"
                                class="w-full flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg shadow-lg hover:shadow-xl"
                            >
                                <Save class="w-5 h-5" />
                                <span>{{
...
const goToPeriode = () => {
    router.visit(route("periode.index"));
};
...
const submit = () => {
    if (isEdit.value) {
        router.put(route("jabatan.update", editId.value), form.value, {
            onSuccess: closeModal,
        });
    } else {
        router.post(route("jabatan.store"), form.value, {
            onSuccess: closeModal,
        });
    }
};
...
function applyFilters() {
    router.get(route("jabatan.index"), filters.value, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
    });
...
const santriData = computed(() =>
    props.data.data.filter((item) => item.IKSASS === "IKSASS Santri")
);

const alumniData = computed(() =>
    props.data.data.filter((item) => item.IKSASS === "IKSASS Alumni")
);
