...
watch(
    ...
    (item) => {
        ...
        form.position_type = item.position_type ?? 'ministry';
        form.instagram = item.instagram;
        form.facebook = item.facebook;
...
function submit() {
    form.post(
        route("pengurus.update", props.pengurus.id),
        {
            forceFormData: true,
            preserveScroll: true,
            ...
            <div
                ...
                <div
                    ...
                    <p class="mt-1 text-sm text-blue-100">
                        Perbarui informasi pengurus yang dipilih.
                    </p>
                </div>
                ...
                <form @submit.prevent="submit" class="modal-scroll flex-1 overflow-y-auto">
                    ...
                    <!-- FOTO SAAT INI -->
                    <div v-if="pengurus?.photo" class="px-6 pb-5">
                        <label class="mb-2 block text-sm font-medium text-slate-700 dark:text-slate-300">
                            Foto Saat Ini
                        </label>
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <p v-if="form.photo" class="mt-2 text-sm text-slate-500 dark:text-slate-400">
                            File dipilih: {{ form.photo.name }}
                        </p>

                        <p v-if="form.errors.photo" class="mt-1 text-sm text-red-500">
                            {{ form.errors.photo }}
                        </p>
                    </div>
